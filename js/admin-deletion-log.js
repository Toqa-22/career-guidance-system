...
const typeLabels = { course: 'Activity', registration: 'Student', hall_reservation: 'Hall Reservation', evaluation: 'Evaluation / Exam', activity_log_entry_edit: 'Activity Log Entry Edit' };
...
function renderTable() {
    ...
    if (allRows.length === 0) {
        tbody.innerHTML = `<tr class="admin-empty-row"><td colspan="5">Nothing has been logged yet.</td></tr>`;
