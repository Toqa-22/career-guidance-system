...
const KASHF3_COLUMN_WIDTHS = [7, 42, 13, 19, 28, 28, 36, 22, 30, 19, 19, 15, 13, 16]; // A إلى N بالترتيب — عريضة للنصوص الطويلة بسطر واحد؛ B (اسم المتدرب) وE-F (المؤسسة التعليمية) وG (التخصص) موسّعة أكثر بطلب صريح؛ العمودان H وN أضيق عمداً لأن عنوانيهما مقسَّمان على سطرين
